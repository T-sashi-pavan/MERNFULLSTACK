import React,{task} from 'react'
class Table extends React.task {
    render() {
        return(
            <form/>
            <empdetails/>
...
class empdetails extends React.task {
    render() {
        return(
            <div class="container-fluid"  style="display: flex;justify-content: flex-end;padding: 10px 0px 10px;background: ghostwhite;">
    <span id="time" style="height: 30px;background: orangered;">01:00</span>&nbsp&nbsp
    <button type="logout" onclick="logout()" style="height: 30px;background: skyblue;"><i class="fa fa-sign-out" aria-hidden="true"></i>
logout</button>
</div>
